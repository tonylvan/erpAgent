<template>
  <div class="smart-query-pro">
    <!-- 顶部导航栏 - 毛玻璃效果 -->
    <header class="top-nav-pro">
      <div class="nav-brand">
        <el-icon :size="24" color="#667eea"><ChatDotRound /></el-icon>
        <span class="brand-text">GSD 智能问数 Pro</span>
      </div>
      <div class="nav-links">
        <el-button 
      ...
      <div class="nav-actions">
        <el-button :icon="Star" circle title="收藏" />
        <el-button :icon="History" circle title="历史" />
        <el-dropdown trigger="click">
          <el-avatar :size="36" src="https://picsum.photos/80/80" class="user-avatar" />
          <template #dropdown>
            <el-dropdown-menu>
                ...
                <div class="message-content-pro">
                  ...
                  <div class="message-bubble-pro">
                    ...
                    <div v-if="msg.role === 'assistant'" class="feedback-actions">
                      <el-button size="small" text :icon="ThumbsUp" @click="handleFeedback(msg.id, 'up')" />
                      <el-button size="small" text :icon="ThumbsDown" @click="handleFeedback(msg.id, 'down')" />
