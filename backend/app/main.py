...
app.include_router(smart_query_v25_router, prefix="/api/v1/smart-query-v25")  #  API v2.5
app.include_router(smart_query_v26_router, prefix="/api/v1/smart-query-v26")  #  API v2.6OpenClaw HTTP API?
